...
from mapping import mapping_sa_pg
...
def get_schema_pg(table_name):   
    ...
    sql = """
select table_name, column_name, data_type, udt_name, character_maximum_length from information_schema.columns
...
def gen(table_name, db_type):
    ...
    if db_type == 'oracle':
        ...
        columns = get_schema_pg(table_name)           
    
    gen_model(table_name, columns, mapping_sa_pg)
