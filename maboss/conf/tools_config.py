...
MABOSS_BASE = 'c:/MTP/mabotech/maboss1.2.2'
...
LOGGING_PATH = MABOSS_BASE+'/var/logs/'

LOGGING_CONFIG = MABOSS_BASE+'/maboss/configuration/logging_config.py'
...
ORA_URL = 'oracle+cx_oracle://xx:xxx@localhost:1521/mesdb?charset=utf8'

#ORA_URL = 'oracle+cx_oracle://flxuser:flxuser@10.177.198.35:1521/gcicpmes?charset=utf8'

PG_URL = 'postgresql+psycopg2://xxx:xxx@localhost:5432/design'
...
#cron task config
CRON_CONF = "C:/MTP/mabotech/maboss1.2/maboss/configuration/cron.csv"
...
TEMPLATE_BASE = MABOSS_BASE+'/maboss/repository/label2/templates'
