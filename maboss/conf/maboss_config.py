...
MABOSS_BASE = 'c:/MTP/mabotech/maboss1.3.0'
...
LOGGING_CONFIG = MABOSS_BASE+'/maboss/conf/logging_config.py'
...
ORA_URL = 'oracle+cx_oracle://xxx:xxx@localhost:1521/mes95?charset=utf8'

#ORA_URL = 'oracle+cx_oracle://xxx:xxx@10.xxx.198.35:1521/xxx?charset=utf8'

PG_URL = 'postgresql+psycopg2://postgres:xxx@localhost:5432/maboss'

DB_URL = 'postgresql+psycopg2://postgres:xxx@localhost:5432/maboss'

#DB_URL ='oracle+cx_oracle://flxuser3x:flxuser@localhost:1521/mesdb?charset=utf8'
